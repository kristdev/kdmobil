											...
											<form action="<?php echo base_url().'office/login/'; ?>create_user" method='POST'>
												<fieldset>
													<label class="block clearfix">
														...
														<?php 
															if(form_error('email')){
																echo '<br>'.form_error('email','<div class="alert alert-warning">', '</div>');
															}
														?>
													</label>
													...
													<label class="block clearfix">
														...
														<?php 
															if(form_error('username')){
																echo '<br>'.form_error('username','<div class="alert alert-warning">', '</div>');
															}
														?>
													</label>
													...
													<label class="block clearfix">
														...
														<?php 
															if(form_error('password')){
																echo '<br>'.form_error('password','<div class="alert alert-warning">', '</div>');
															}
														?>
													</label>
													...
													<label class="block clearfix">
														...
														<?php 
															if(form_error('passconf')){
																echo '<br>'.form_error('passconf','<div class="alert alert-warning">', '</div>');
															}
														?>
													</label>
										...
										<div class="widget-main">
											...
											<form action="<?php echo base_url().'office/login/'; ?>authentification" method="POST">
												<fieldset>
													...
													<div class="clearfix">
														<label class="inline">
															<input name="remeber" value="true" type="checkbox" class="ace" />
